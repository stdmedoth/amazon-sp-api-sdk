 ...
 */
class CreateQueryResponse implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
    ...
    public function validate() : void
    {
        if ($this->container['query_id'] !== null) {
            $this->container['query_id']->validate();
        }
    }
     ...
     */
    public function getQueryId() : array
    {
